...
namespace Gomoku.UI.Control.EffectEx.InvertedColorEffect
{
    public class InvertColorEffect : ShaderEffect
    {
        ...
        public InvertColorEffect()
        {
            ...
            {
                UriSource = new Uri($"pack://application:,,,/{AssemblyName};component/Control/EffectEx/InvertedColorEffect/InvertedColorEffect.ps"),
            };
