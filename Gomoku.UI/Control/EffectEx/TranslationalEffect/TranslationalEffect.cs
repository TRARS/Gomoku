...
namespace Gomoku.UI.Control.EffectEx.TranslationalEffect
{
    public class TranslationalEffect : ShaderEffect
    {
        ...
        public TranslationalEffect()
        {
            ...
            {
                UriSource = new Uri($"pack://application:,,,/{AssemblyName};component/Control/EffectEx/TranslationalEffect/TranslationalEffect.ps"),
            };
